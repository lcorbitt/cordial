...
export const ERROR_TITLE = "We Could Not Load This Community";
...
export const CARD_TITLE = "Community Home";
export const CARD_DESCRIPTION =
  "Forums, discussions, and member content will appear here in a later release.";
export const BODY_PREFIX = "You are viewing the home for";
export const BODY_SUFFIX =
