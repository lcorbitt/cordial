...
export const FLAG_ON_PREFIX_BODY = "The new dashboard is";
export const FLAG_ON_SUFFIX_BODY = "for you.";
export const FLAG_ON_LABEL = "on";
export const FLAG_OFF_LABEL = "off";
